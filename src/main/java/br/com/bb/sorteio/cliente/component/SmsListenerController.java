...
public class SmsListenerController {
    ...
    private static final String QUEUE_NAME = "sms-sent-successfully";
    ...
    public void listenSmsMessageSucessfullySent(final String clienteMessage) {
        ...
        clienteService.changeStatusForSmsSentSuccessfully(nroCpf);
